...
summary(modelo)
performance::check_model(modelo, check ='qq')
performance::check_model(modelo, check ='homogeneity')
performance::check_model(modelo, check ='linearity')
# Diagnóstico visual
 performance::check_model(modelo, FALSE) # Lembrar de aumentar a região de plotagem
